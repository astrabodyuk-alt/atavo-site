...
.footer-aurora {
  background: radial-gradient(
    circle at 50% 50%,
    color-mix(in oklch, #00c47a 15%, transparent) 0%,
    color-mix(in oklch, #00c47a 8%, transparent) 40%,
    transparent 70%
  );
}
  ...
  return (
    <>
      ...
      {/*
        ...
        Sits in normal flow; clip-path confines the fixed footer to this box.
      */}
      <div
        ref={wrapperRef}
      ...
      >
        {/* Fixed footer — visible only through the clip-path above */}
